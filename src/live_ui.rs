    ...
    async fn render_connections(&self) {
        ...
        for launcher in launchers {
            ...
            let status_icon = match launcher.status {
                crate::protocol::LauncherStatus::Connected => "🟡",
                crate::protocol::LauncherStatus::Active => "🟢",
                crate::protocol::LauncherStatus::Idle => "⚪",
                crate::protocol::LauncherStatus::Disconnected => "🔴",
            };
